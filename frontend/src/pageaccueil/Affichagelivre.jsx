...
export default function Affichagelivre({ livres = [] }) { 
    const derniersLivres = Array.isArray(livres) ? livres.slice(-5) : [];
    ...
    return (
        <fieldset style={{ border: "2px solid #ff4081", padding: "20px", borderRadius: "10px", backgroundColor: "#121212", color: "white", textAlign: "right" }}>
            <legend style={{ fontSize: "20px", fontWeight: "bold", color: "#ff4081", float: "right", padding: "0 10px" }}>📚 آخر الكتب</legend>
